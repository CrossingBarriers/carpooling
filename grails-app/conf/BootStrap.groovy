...
class BootStrap {
	...
	def init = { servletContext ->
		...
		def usuario1 = new Usuario(accountExpired:false,accountLocked:false,enabled:true,class:carpooling.SecUsuario,dni: 33222000, nombre: 'Maria', apellido: 'Lopez', username: 'marialopez@gmail.com',imagen:"D:\\33222000.jpg",ocupacion:'Estudiante en UNLAM', telefono: 35282463 , password: '123', passwordExpired:false,conductor: false)
		usuario1.save()
