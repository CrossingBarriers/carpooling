...
class BootStrap {
	...
	def init = { servletContext ->
		...
		//USUARIOS:
		def usuario1 = new Usuario(accountExpired:false,accountLocked:false,enabled:true,class:carpooling.SecUsuario,dni: 33222000, nombre: 'Maria', apellido: 'Lopez', username: 'marialopez@gmail.com',imagen:"D:\\33222000.jpg",ocupacion:'Estudiante en UNLAM', telefono: 35282463 , password: '123', passwordExpired:false,conductor: true)
		usuario1.save()
		//println usuario1

		def usuario2 = new Usuario(accountExpired:false,accountLocked:false,enabled:true,class:carpooling.SecUsuario,dni: 29157077, nombre: "Lucia", apellido: "Roldan", username: "luciaroldan@gmail.com",imagen:"D:\\29157077.jpg", ocupacion:'Auditora en Nestle', telefono: 44414566 , password: 'abc123', passwordExpired:false,conductor: false)
		usuario2.save()
		//println usuario2

		def usuario3 = new Usuario(accountExpired:false,accountLocked:false,enabled:true,class:carpooling.SecUsuario,dni: 27100732, nombre: "Marcos", apellido: "Suarez", username: "marcossuarez@gmail.com",imagen:"D:\\27100732.jpg",ocupacion:'Electricista matriculado', telefono: 1530992164 , password: 'mar123',passwordExpired:false, conductor: true)
		usuario3.save()
		//println usuario3

		def usuario4 = new Usuario(accountExpired:false,accountLocked:false,enabled:true,class:carpooling.SecUsuario,dni: 36908127, nombre: "Patricia", apellido: "Peralta", username: "patriciaperalta@gmail.com",imagen:"D:\\36908127.jpg",ocupacion:'Contadora senior en Techint', telefono: 46890244 , password: 'pat123',passwordExpired:false, conductor: false)
		usuario4.save()
		//println usuario4

		def usuario5 = new Usuario(accountExpired:false,accountLocked:false,enabled:true,class:carpooling.SecUsuario,dni: 29875321, nombre: "Martina", apellido: "Ponce", username: "martinaponce@gmail.com",imagen:"D:\\29875321.jpg",ocupacion:'Estudiante en UM', telefono: 1567204311 , password: 'mpo123',passwordExpired:false, conductor: true)
		usuario5.save()
		//println usuario5

		def usuario6 = new Usuario(accountExpired:false,accountLocked:false,enabled:true,class:carpooling.SecUsuario,dni: 33678600, nombre: "Romina", apellido: "Monte", username: "rominamonte@gmail.com",imagen:"D:\\33678600.jpg",ocupacion:'Trabajo en recursos humanos', telefono: 1530908844 , password: 'rom123',passwordExpired:false, conductor: false)
		usuario6.save()
		//println usuario6
		...
		def vehiculo2 = new Vehiculo(patente: "JAA123", marca: "Chevrolet", modelo: "Corsa", cantidadAsientos: 4, imagen:"D:\\JAA123.jpg",usuario: usuario3) // El usuario 3 es conductor
		vehiculo2.save()
		//println vehiculo2
