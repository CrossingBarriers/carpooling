					...
					<div class="row">
						<div class="col-md-8">
							...
							<h5>
								...
								${detalleViaje.viaje.vehiculo.usuario.nombre}
							</h5>
							<h5>
								<strong>Apellido: </strong>
								${detalleViaje.viaje.vehiculo.usuario.apellido}
							</h5>
							<h5>
								<strong>DNI: </strong>
								${detalleViaje.viaje.vehiculo.usuario.dni}
							</h5>
							<h5>
								<strong>Teléfono: </strong>
								${detalleViaje.viaje.vehiculo.usuario.telefono}
							</h5>
							<br />
						</div>
						<div class="col-md-4">
